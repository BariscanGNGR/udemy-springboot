...
insert into users values ('user2','{bcrypt}$2a$10$ADTJz74SO/XDrykaPua/.O8E3.3uEOV1o8ASPVSxim8fFHdpJ.4qq',true);
insert into users values ('user3','{bcrypt}$2a$10$jIjJHMw/ZuewD85twxns2ueja/ZDRklQYteDbHlHz5xRgGswO6PAC',true);
